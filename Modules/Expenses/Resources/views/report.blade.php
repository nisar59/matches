          ...
          <div class="section-body">
            <div class="row">
              ...
              <div class="col-12">
                <div class="card card-primary">
                  <div class="card-header">
                    <h4 class="col-md-6">Expenses Report</h4>
                ...
                buttons:[
                      {
                        ...
                        buttons:[
                            {
                              extend:'excelHtml5',
                              title:'{{Settings()->portal_name}}-Expenses Report',
                              exportOptions: {
                            ...
                            {
                              extend:'print',
                              title:'<h2 class="text-center mb-2">{{Settings()->portal_name}}</h2><h4 class="text-center mb-5">Expenses Report</h4>',
                              exportOptions: {
                              columns: [0,1,2,3,4,5,6,7],
                              search: 'applied',
                              order: 'applied',                              
